...
namespace MELHARFI.Gfx
{
    public class Anim : IGfx
    {
        ...
        /// <summary>
        /// Name of the object, usfull if you need to search it by its name, by default "unnamed"
        /// </summary>
        ...
        public Anim(int interval, byte crypt)
        {
            Crypted = true;
            Crypt = crypt;
            _interval = interval;
        ...
        public void Visible(bool _visible)                  // écriture seul
        {
            img.visible = _visible;
        }
        ...
        public void Zindex(int i)                       // écriture seul
        {
            img.zindex = i;
        }
        ...
        public void Ini(MELHARFI.Manager.TypeGfx typeGfx, bool crypted)
        {
            switch (typeGfx)
            {
                case MELHARFI.Manager.TypeGfx.Bgr:
                    img = crypted ? new Bmp(cellList[0].cell, new Point(cellList[Counter].posX, cellList[Counter].posY), "unamedAnim", MELHARFI.Manager.TypeGfx.Bgr, true, Crypt) : new Bmp(cellList[0].cell, new Point(cellList[Counter].posX, cellList[Counter].posY), "unamedAnim", MELHARFI.Manager.TypeGfx.Bgr, true);

                    img.TypeGfx = MELHARFI.Manager.TypeGfx.Bgr;
                    break;
                case MELHARFI.Manager.TypeGfx.Obj:
                    img = crypted ? new Bmp(cellList[0].cell, new Point(cellList[Counter].posX, cellList[Counter].posY), "unamedAnim", MELHARFI.Manager.TypeGfx.Obj, true, Crypt) : new Bmp(cellList[0].cell, new Point(cellList[Counter].posX, cellList[Counter].posY), "unamedAnim", MELHARFI.Manager.TypeGfx.Obj, true);
                    img.TypeGfx = MELHARFI.Manager.TypeGfx.Obj;
                    break;
                case MELHARFI.Manager.TypeGfx.Top:
                    img = crypted ? new Bmp(cellList[0].cell, new Point(cellList[Counter].posX, cellList[Counter].posY), "unamedAnim", MELHARFI.Manager.TypeGfx.Top, true, Crypt) : new Bmp(cellList[0].cell, new Point(cellList[Counter].posX, cellList[Counter].posY), "unamedAnim", MELHARFI.Manager.TypeGfx.Top, true);
                    img.TypeGfx = MELHARFI.Manager.TypeGfx.Top;
                    break;
                default:
        ...
        /// <param name="crypted">Boolean value indicating if the picture is encrypted or not</param>
        public void Ini(MELHARFI.Manager.TypeGfx typeGfx, string Name, bool crypted)
        {
            switch (typeGfx)
            {
                case MELHARFI.Manager.TypeGfx.Bgr:
                    img = crypted ? new Bmp(cellList[0].cell, new Point(cellList[Counter].posX, cellList[Counter].posY), Name, MELHARFI.Manager.TypeGfx.Bgr, true, Crypt) : new Bmp(cellList[0].cell, new Point(cellList[Counter].posX, cellList[Counter].posY), Name, MELHARFI.Manager.TypeGfx.Bgr, true);
                    img.TypeGfx = MELHARFI.Manager.TypeGfx.Bgr;
                    break;
                case MELHARFI.Manager.TypeGfx.Obj:
                    img = crypted ? new Bmp(cellList[0].cell, new Point(cellList[Counter].posX, cellList[Counter].posY), Name, MELHARFI.Manager.TypeGfx.Obj, true, Crypt) : new Bmp(cellList[0].cell, new Point(cellList[Counter].posX, cellList[Counter].posY), Name, MELHARFI.Manager.TypeGfx.Bgr, true);
                    img.TypeGfx = MELHARFI.Manager.TypeGfx.Obj;
                    break;
                case MELHARFI.Manager.TypeGfx.Top:
                    img = crypted ? new Bmp(cellList[0].cell, new Point(cellList[Counter].posX, cellList[Counter].posY), Name, MELHARFI.Manager.TypeGfx.Top, true, Crypt) : new Bmp(cellList[0].cell, new Point(cellList[Counter].posX, cellList[Counter].posY), Name, MELHARFI.Manager.TypeGfx.Bgr, true);
                    img.TypeGfx = MELHARFI.Manager.TypeGfx.Top;
        ...
        /// <param name="crypted">Boolean value indicating if the picture is encrypted or not</param>
        public void Ini(MELHARFI.Manager.TypeGfx typeGfx, Rectangle rectangle, bool crypted)
        {
            switch (typeGfx)
            {
                case MELHARFI.Manager.TypeGfx.Bgr:
                    img = crypted ? new Bmp(cellList[0].cell, new Point(cellList[Counter].posX, cellList[Counter].posY), "unamedAnim", MELHARFI.Manager.TypeGfx.Bgr, true, Crypt, rectangle) : new Bmp(cellList[0].cell, new Point(cellList[Counter].posX, cellList[Counter].posY), "unamedAnim", MELHARFI.Manager.TypeGfx.Bgr, true, rectangle);
                    img.rectangle = cellList[0].rec;
                    img.TypeGfx = MELHARFI.Manager.TypeGfx.Bgr;
                    break;
                case MELHARFI.Manager.TypeGfx.Obj:
                    img = crypted ? new Bmp(cellList[0].cell, new Point(cellList[Counter].posX, cellList[Counter].posY), "unamedAnim", MELHARFI.Manager.TypeGfx.Obj, true, Crypt, rectangle) : new Bmp(cellList[0].cell, new Point(cellList[Counter].posX, cellList[Counter].posY), "unamedAnim", MELHARFI.Manager.TypeGfx.Obj, true, rectangle);
                    img.rectangle = cellList[0].rec;
                    img.TypeGfx = MELHARFI.Manager.TypeGfx.Obj;
                    break;
                case MELHARFI.Manager.TypeGfx.Top:
                    img = crypted ? new Bmp(cellList[0].cell, new Point(cellList[Counter].posX, cellList[Counter].posY), "unamedAnim", MELHARFI.Manager.TypeGfx.Top, true, Crypt, rectangle) : new Bmp(cellList[0].cell, new Point(cellList[Counter].posX, cellList[Counter].posY), "unamedAnim", MELHARFI.Manager.TypeGfx.Top, true, rectangle);
                    img.rectangle = cellList[0].rec;
                    img.TypeGfx = MELHARFI.Manager.TypeGfx.Top;
                    break;
                default:
        ...
        /// <param name="Name">Name of the object, usfull if you need to search it by its name</param>
        /// <param name="crypted">Boolean value indicating if the picture is encrypted or not</param>
        public void Ini(MELHARFI.Manager.TypeGfx typeGfx, Rectangle rectangle, string Name, bool crypted)
        {
            switch (typeGfx)
            {
                case MELHARFI.Manager.TypeGfx.Bgr:
                    img = crypted ? new Bmp(cellList[0].cell, new Point(cellList[Counter].posX, cellList[Counter].posY), Name, MELHARFI.Manager.TypeGfx.Bgr, true, Crypt, rectangle) : new Bmp(cellList[0].cell, new Point(cellList[Counter].posX, cellList[Counter].posY), Name, MELHARFI.Manager.TypeGfx.Bgr, true, rectangle);
                    img.rectangle = cellList[0].rec;
                    img.TypeGfx = MELHARFI.Manager.TypeGfx.Bgr;
                    break;
                case MELHARFI.Manager.TypeGfx.Obj:
                    img = crypted ? new Bmp(cellList[0].cell, new Point(cellList[Counter].posX, cellList[Counter].posY), Name, MELHARFI.Manager.TypeGfx.Obj, true, Crypt, rectangle) : new Bmp(cellList[0].cell, new Point(cellList[Counter].posX, cellList[Counter].posY), Name, MELHARFI.Manager.TypeGfx.Obj, true, rectangle);
                    img.rectangle = cellList[0].rec;
                    img.TypeGfx = MELHARFI.Manager.TypeGfx.Obj;
                    break;
                case MELHARFI.Manager.TypeGfx.Top:
                    img = crypted ? new Bmp(cellList[0].cell, new Point(cellList[Counter].posX, cellList[Counter].posY), Name, MELHARFI.Manager.TypeGfx.Top, true, Crypt, rectangle) : new Bmp(cellList[0].cell, new Point(cellList[Counter].posX, cellList[Counter].posY), Name, MELHARFI.Manager.TypeGfx.Top, true, rectangle);
                    img.rectangle = cellList[0].rec;
                    img.TypeGfx = MELHARFI.Manager.TypeGfx.Top;
                    break;
            }
        ...
        /// </summary>
        /// <param name="visible">If visible is true, the object is visible, if false the object is invisible</param>
        ...
        public void AddCell(string asset, int id, int posX, int posY, int width, int height, float opacity)
        {
            ...
            cell.bitmap = MELHARFI.Manager.ChangeOpacity(cell.bitmap, opacity);
            cellList.Add(cell);
        }
        ...
        public void AddCell(string asset, int id, int posX, int posY, float opacity)
        {
            ...
            cell.bitmap = MELHARFI.Manager.ChangeOpacity(tmp, opacity);
            cellList.Add(cell);
        }
