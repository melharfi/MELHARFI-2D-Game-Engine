...
namespace MELHARFI.Gfx
{
    public class Rec : IGfx
    {
        ...
        /// Boolean value indicating if the object is visible or invisible, value read only
        /// </summary>
        /// <param name="_visible">Return a boolean value</param>
        ...
        public Rec(Brush b, Point _point, Size _size, string _name, MELHARFI.Manager.TypeGfx _typeGfx, bool _visible)
        {
            _brush = b;
            point = _point;
            size = _size;
